...
export const bounce = keyframes`  
  ...
  15% { transform: translateY(-14px) scaleY(1.05); }  
  30% { transform: translateY(0) scaleY(0.92); }  
  40% { transform: translateY(-6px) scaleY(1.02); }  
  55% { transform: translateY(0) scaleY(0.97); }  
  65% { transform: translateY(-2px) scaleY(1.01); }  
  75%, 100% { transform: translateY(0) scaleY(1); }  
`  
...
export const dotsLoop = keyframes`  
  0% { content: ''; }  
  25% { content: '.'; }  
  50% { content: '..'; }  
  75% { content: '...'; }  
...
export const glowDiagonalLoop = keyframes`  
  0% { transform: translate(-120%, -120%) rotate(45deg) scale(0.9); opacity: 0; }  
  10% { opacity: 1; }  
  50% { transform: translate(40%, 40%) rotate(45deg) scale(2); opacity: 0.7; }  
  100% { transform: translate(120%, 120%) rotate(45deg) scale(0.9); opacity: 0; }  
`  
...
export const rotateSilverAngle = keyframes`  
  from { --silver-angle: 0deg; }  
  to { --silver-angle: 360deg; }  
`  
  
export const starFlash = keyframes`  
  0%, 70% { opacity: 0; transform: translate(50%, -50%) scale(0.2); }  
  74% { opacity: 1; transform: translate(50%, -50%) scale(1); }  
  78% { opacity: 1; transform: translate(50%, -50%) scale(1.2); }  
  82%, 100% { opacity: 0; transform: translate(50%, -50%) scale(0.3); }  
`  
...
export const rocketTrajectory = keyframes`  
  0% { transform: translate(-700px, 700px) scale(0.85) rotate(-8deg); opacity: 0; }  
  ...
  70% { transform: translate(-10px, 0) scale(1.05) rotate(-6deg); }  
  80% { transform: translate(150px, -150px) scale(1.5) rotate(8deg); }  
  100% { transform: translate(100px, -100px) scale(2) rotate(18deg); opacity: 1; }  
`  
  
export const lightningStrikeMove = keyframes`  
  0% { transform: translate(150px, -150px) rotate(15deg); opacity: 0; }  
  10% { transform: translate(0, 0) rotate(0deg); opacity: 1; }  
  ...
  35% { transform: translate(-5px, 0) rotate(-2deg) scale(0.98); }  
  ...
  55% { transform: translate(-3px, 0) rotate(-1deg) scale(0.98); }  
  60% { transform: translate(1px, 0) rotate(1deg) scale(1.03); }  
  65% { transform: translate(0, 0) rotate(0deg) scale(1); }  
  75% { opacity: 0.6; transform: scale(0.9); }  
  85% { opacity: 0; transform: scale(0.8); }  
  100% { opacity: 0; transform: translate(150px, -150px) scale(0.8); }  
`  
  
/* ===========================================================  
   REVEAL (entrada — sempre com opacidade)  
=========================================================== */  
...
export const slideImpactRight = keyframes`  
  0% { opacity: 0; transform: translateX(-160px) scaleX(0.92); }  
  45% { opacity: 1; transform: translateX(0) scaleX(1.08); }  
  60% { transform: translateX(-14px) scaleX(0.97); }  
  72% { transform: translateX(6px) scaleX(1.02); }  
...
export const slideImpactUp = keyframes`  
  0% { opacity: 0; transform: translateY(160px) scaleY(0.9); }  
  45% { opacity: 1; transform: translateY(0) scaleY(1.08); }  
  60% { transform: translateY(14px) scaleY(0.96); }  
  72% { transform: translateY(-6px) scaleY(1.02); }  
...
export const blurRise = keyframes`  
  0% { opacity: 0; filter: blur(10px); transform: translateY(18px) scale(0.97); }  
...
export const cinematicZoom = keyframes`  
  0% { opacity: 0; transform: scale(0.72) translateY(30px); }  
...
export const rotateSoftDrop = keyframes`  
  0% { opacity: 0; transform: translateY(-24px) rotate(-5deg); }  
...
export const softRevealUp = keyframes`  
  from { opacity: 0; transform: translateY(-22px); }  
  to { opacity: 1; transform: translateY(0); }  
`  
  
export const smoothBounceUp = keyframes`  
...
/* Reveals modernos novos: máscara via clip-path (sem "pulo" de layout) */  
...
/* Flip novo COM opacidade (substitui o rotateFull "cru" nos reveals) */  
export const flipInX = keyframes`  
  0% { opacity: 0; transform: perspective(800px) rotateX(-90deg); }  
  60% { opacity: 1; transform: perspective(800px) rotateX(12deg); }  
...
export const flipInY = keyframes`  
  ...
  60% { opacity: 1; transform: perspective(800px) rotateY(12deg); }  
